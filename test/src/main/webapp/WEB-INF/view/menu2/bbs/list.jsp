...
<div class="bodyFrame2">
    ...
    <div class="alert alert-info">
        <i class="glyphicon glyphicon-info-sign"></i> 자유로이 토론할 수 있는 공간입니다.
    </div>
    ...
    <div>
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="dto" items="${list}">
                    <tr>
                        ...
                        <img src="<%=cp%>/res/images/disk.gif" border="0" style="margin-top:1px;">                                             
                        </a>
                        </c:if> 
                        </td> <!-- 파일다운로드  --> --%>
        ...
        <div style="clear: both;">
        		...
        		<div style="float: left; width: 20%; min-width: 85px; text-align: right;">
        		    <button type="button" class="btn btn-primary btn-sm bbtn" onclick="javascript:location.href='<%=cp%>/bbs/created';">
