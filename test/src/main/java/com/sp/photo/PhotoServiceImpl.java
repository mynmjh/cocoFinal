...
import com.sp.bbs.BoardController;
...
public class PhotoServiceImpl implements PhotoService {
	...
	@Override
	public int deletePhotoId(String s_num, String root) {
		int result=0;
		// 회원이 탈퇴한 경우 게시물 삭제.
...
//			
//			List<Board>list=dao.getListData("photo.listPhotoId", s_num);
//			for(Board dto:list) {
...
//			}
//			
//			dao.deleteData("bbs.deletePhotoId", s_num);
//			
//		} catch (Exception e) {
//		}
